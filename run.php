...
use Matchesfashion\ProxyGetter;
...
$proxyStorage = new ProxyGetter('./proxy_list.txt');

$loop = React\EventLoop\Factory::create();

$proxy = new ProxyConnector('http://' . $proxyStorage->getProxy(), new Connector($loop));
...
$scraperSubCategory->scrape($scraperCategory->getData(), [], 2);
$loop->run();
